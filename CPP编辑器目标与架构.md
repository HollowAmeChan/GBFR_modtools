...
> 实施状态（2026-07-16）：M0-M5 已完成首轮实现。C++ 已覆盖工作区、模型解析/构建、D3D11 预览、骨架与 CLH/CLP 联动；texture、mmat、BXM 编码和新建 texture 继续走旧版兼容入口。具体边界与验证见 [CPP编辑器构建与迁移.md](CPP编辑器构建与迁移.md)。
