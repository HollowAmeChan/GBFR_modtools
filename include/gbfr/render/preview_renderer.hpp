...
private:
    ...
    unsigned collision_vertex_count_{};
    ...
    Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> color_srv_, albedo_srv_;
    Microsoft::WRL::ComPtr<ID3D11DepthStencilView> depth_dsv_;
    Microsoft::WRL::ComPtr<ID3D11Buffer> vertices_, indices_, lines_, constants_;
